...
# Android Banuba AI Video Editor Playback API Integration Sample

This repository contains an example of using AI Video Editor Playback API in your android app.

Playback API can apply configurable visual and music effects to video and play them together.
...
## Requirements
This is what you need to run the Playback API
- Java 1.8+
- Kotlin 1.4+
- Android Studio 4+
...
List of Video Editor APIs utilized in playback sample.
